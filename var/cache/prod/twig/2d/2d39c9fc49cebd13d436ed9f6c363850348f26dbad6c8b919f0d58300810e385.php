...
class __TwigTemplate_14a03402dfc0da74d282a310d3fc5493296ca5480838d06d23a10fe7ed3b813a extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"list-pagination\">
    <div class=\"list-pagination-counter\">
        ";
        // line 7
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("paginator.results", ["%count%" => sprintf(twig_get_attribute($this->env, $this->source, ($context["paginator"] ?? null), "numResults", [], "any", false, false, false, 7))], "EasyAdminBundle");
        echo "
    </div>
    ...
    <nav class=\"pager list-pagination-paginator ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
            ...
            echo (((0 === twig_compare($context["page"], twig_get_attribute($this->env, $this->source, ($context["paginator"] ?? null), "currentPage", [], "any", false, false, false, 19)))) ? ("active") : (""));
            echo " ";
...
";
    ...
    {
        return new Source("", "@EasyAdmin/crud/paginator.html.twig", "C:\\wamp64\\www\\chalonn1-master\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\paginator.html.twig");
    }
}
